...
def run_inference(trained_model_path, output_directory, num_sentences):
    """
    ...
    for i in range(num_sentences):
        speech = quest_generator("<SOS>", max_length=200, min_length=10, do_sample=True, temperature=1.2)[0]['generated_text']
...
if __name__ == "__main__":
    ...
    if not is_valid_directory(output_directory):
        ...
        run_inference(trained_model_path, output_directory, num_sentences)
